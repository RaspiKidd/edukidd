                ...
                <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
                    <div class="flex justify-start lg:w-0 lg:flex-1">
                        <NuxtLink to="/">
                            ...
                            <img class="h-8 w-auto sm:h-20" src="@/static/EduKidd.png" alt="Logo">
                        </NuxtLink>
                    </div>
                    ...
                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        <div class="pt-5 pb-6 px-5">
                            <div class="flex items-center justify-between">
                                <NuxtLink to="/">
                                    <img class="h-8 w-auto sm:h-10" src="@/static/EduKidd.png" alt="Logo">
                                </NuxtLink>
                                <div class="-mr-2">
            ...
            <div class="relative max-w-7xl mx-auto">
                <div class="text-center">
                    ...
                    <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4 font-extrabold" style="color:#76B82A;">
                        Raspberry Pi tutorials created with the EduBlocks programming language a drag and drop Python editor
                    </p>
                </div>
                ...
                <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-48 object-cover" src="@/static/images/ScratchLogo.png" alt="Scratch Logo">
                        </div>
                            ...
                            <div class="flex-1">
                                <NuxtLink to="/MakeCode" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        Tutorials created using the Scratch Editor
                                    </p>
                                </NuxtLink>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-48 object-cover" src="@/static/images/EduBlocksLogo.jpeg" alt="EduBlocks Logo">
                        </div>
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                ...
                                <NuxtLink to="/EduBlocks" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        Tutorials created using the EduBlocks Editor
                                    </p>
                                </NuxtLink>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-48 object-cover" src="@/static/images/PythonLogo.png" alt="Python logo">
                        </div>
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                <NuxtLink to="/microPython" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        Tutorials created using the Python Editor
                                    </p>
                                </NuxtLink>
                            </div>
                        </div>
