            ...
            <div class="relative max-w-7xl mx-auto">
                <div class="text-center">
                    ...
                    <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4 font-extrabold" style="color:#76B82A;">
                        micro:bit tutorials created with the EduBlocks editor a drag and drop Python editor
                    </p>
                </div>
                ...
                <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-48 object-cover" src="@/static/images/MakeCodeLogo.png" alt="MakeCode Logo">
                        </div>
                            ...
                            <div class="flex-1">
                                <NuxtLink to="/MakeCode" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        Tutorials created using the MakeCode Editor
                                    </p>
                                </NuxtLink>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                <NuxtLink to="/microPython" class="block mt-2">
                                    ...
                                    <p class="mt-3 text-base text-gray-500">
                                        Tutorials created using the microPython Editor
                                    </p>
                                </NuxtLink>
                            </div>
                        </div>
